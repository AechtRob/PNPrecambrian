...
public class GenLayerStromatolitePavement extends GenLayer
{

    public Biome STROMATOLITE_PAVEMENT = Biome.REGISTRY.getObject(new ResourceLocation("lepidodendron:ediacaran_stromatolite_pavement"));
    public int STROMATOLITE_PAVEMENT_ID =  Biome.getIdForBiome(STROMATOLITE_PAVEMENT);
    ...
    public GenLayerStromatolitePavement(long seed, GenLayer genLayer)
    {
        super(seed);
               ...
               if (isEdiacaran(k))
                {
                    ...
                    {
                        aint1[j + i * areaWidth] = STROMATOLITE_PAVEMENT_ID;
                    }
                    else {
