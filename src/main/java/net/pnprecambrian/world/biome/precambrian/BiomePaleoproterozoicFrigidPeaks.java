...
public class BiomePaleoproterozoicFrigidPeaks extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:paleoproterozoic_frigid_peaks")
	public static final BiomeGenCustom biome = null;
	public BiomePaleoproterozoicFrigidPeaks(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomePrecambrian {
		public BiomeGenCustom() {
			...
			super(new BiomeProperties("Paleoproterozoic Frigid Peaks").setRainfall(0.0F).setBaseHeight(9.00F).setHeightVariation(0.025F).setTemperature(0.1F).setWaterColor(0xB00000));
			setRegistryName("lepidodendron:paleoproterozoic_frigid_peaks");
