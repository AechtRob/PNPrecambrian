...
public class BiomeEdiacaranShallowReef extends ElementsPNPrecambrianMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:ediacaran_shallow_reef")
	public static final BiomeGenCustom biome = null;
	public BiomeEdiacaranShallowReef(ElementsPNPrecambrianMod instance) {
		super(instance, 1591);
	}
	...
	static class BiomeGenCustom extends BiomePrecambrian {
		public BiomeGenCustom() {
			super(new BiomeProperties("Ediacaran Shallow Reef").setRainfall(0.95F).setBaseHeight(2.35F).setHeightVariation(0.00F).setTemperature(1.1F));
			setRegistryName("lepidodendron:ediacaran_shallow_reef");
	    ...
	    public void decorate(World worldIn, Random rand, BlockPos pos)
	    {
			...
			for (int i = 0; i < 32; ++i) {
				LITTER.generate(worldIn, rand, pos.add(rand.nextInt(16) + 8, 0, rand.nextInt(16) + 8), 90, 120, BlockStromatolite.block.getDefaultState(), -1);
			}

			for (int i = 0; i < 32; ++i) {
				LITTER.generate(worldIn, rand, pos.add(rand.nextInt(16) + 8, 0, rand.nextInt(16) + 8), 90, 120, BlockStromatolite.block.getDefaultState(), 0);
			}

			for (int i = 0; i < 8; ++i) {
				LITTER.generate(worldIn, rand, pos.add(rand.nextInt(16) + 8, 0, rand.nextInt(16) + 8), 90, 120, BlockThrombolite.block.getDefaultState(), -1);
			}

			for (int i = 0; i < 8; ++i) {
				LITTER.generate(worldIn, rand, pos.add(rand.nextInt(16) + 8, 0, rand.nextInt(16) + 8), 90, 120, BlockThrombolite.block.getDefaultState(), 0);
			}
