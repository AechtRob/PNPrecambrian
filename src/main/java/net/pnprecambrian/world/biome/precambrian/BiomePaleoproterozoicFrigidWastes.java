...
public class BiomePaleoproterozoicFrigidWastes extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:paleoproterozoic_frigid")
	public static final BiomeGenCustom biome = null;
	public BiomePaleoproterozoicFrigidWastes(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomePrecambrian {
		public BiomeGenCustom() {
			...
			super(new BiomeProperties("Paleoproterozoic Frigid Peaks").setRainfall(0.0F).setBaseHeight(5.00F).setHeightVariation(0.2F).setTemperature(0.1F).setWaterColor(0xB00000));
			setRegistryName("lepidodendron:paleoproterozoic_frigid");
