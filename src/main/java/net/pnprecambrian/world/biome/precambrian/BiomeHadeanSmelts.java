...
public class BiomeHadeanSmelts extends ElementsPNPrecambrianMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:hadean_smelts")
	public static final BiomeGenCustom biome = null;
	public BiomeHadeanSmelts(ElementsPNPrecambrianMod instance) {
		super(instance, 1591);
	}
