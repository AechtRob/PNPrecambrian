...
public class BiomeCryogenianBeach extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:cryogenian_beach")
	public static final BiomeGenCustom biome = null;
	public BiomeCryogenianBeach(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomePrecambrian {
		public BiomeGenCustom() {
			...
			super(new BiomeProperties("Cryogenian Ice Ocean").setRainfall(0.0F).setBaseHeight(2.75F).setHeightVariation(0.001F).setTemperature(0.1F).setSnowEnabled().setWaterColor(11556675));
			setRegistryName("lepidodendron:cryogenian_beach");
