...
public class BiomeEdiacaranFrondoseForest extends ElementsPNPrecambrianMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:ediacaran_frondose_forest")
	public static final BiomeGenCustom biome = null;
	public BiomeEdiacaranFrondoseForest(ElementsPNPrecambrianMod instance) {
		super(instance, 1591);
	}
	...
	static class BiomeGenCustom extends BiomePrecambrian {
	    ...
	    public void decorate(World worldIn, Random rand, BlockPos pos)
	    {
			...
			if(net.minecraftforge.event.terraingen.TerrainGen.decorate(worldIn, rand, new net.minecraft.util.math.ChunkPos(pos), net.minecraftforge.event.terraingen.DecorateBiomeEvent.Decorate.EventType.GRASS)) {
				...
				for (int i = 0; i < Math.ceil(5D * edicarandensity); ++i) {
					int j = rand.nextInt(16) + 8;
					int k = rand.nextInt(16) + 8;
					int l = ChunkGenSpawner.getTopSolidBlock(new BlockPos(pos.add(i, 0, k)), worldIn).getY() + 1;
					if (worldIn.getBiome(pos.add(j, l, k)) == this && rand.nextInt(8) != 0) {
			...
			if(net.minecraftforge.event.terraingen.TerrainGen.decorate(worldIn, rand, new net.minecraft.util.math.ChunkPos(pos), net.minecraftforge.event.terraingen.DecorateBiomeEvent.Decorate.EventType.GRASS)) {
				...
				for (int i = 0; i < Math.ceil(8D * edicarandensity); ++i) {
					...
					if (worldIn.getBiome(pos.add(j, l, k)) == this) {
						STATIC_ROTATIONAL_GENERATOR.generate(BlockCharniodiscus.block.getDefaultState(), worldIn, rand, pos.add(j, l, k), 8, 255, 0, 38);
					}
				}
			}
			...
			if(net.minecraftforge.event.terraingen.TerrainGen.decorate(worldIn, rand, new net.minecraft.util.math.ChunkPos(pos), net.minecraftforge.event.terraingen.DecorateBiomeEvent.Decorate.EventType.GRASS)) {
				...
				for (int i = 0; i < Math.ceil(5D * edicarandensity); ++i) {
					...
					int l = ChunkGenSpawner.getTopSolidBlock(new BlockPos(pos.add(i, 0, k)), worldIn).getY() + 1;
					if (worldIn.getBiome(pos.add(j, l, k)) == this && rand.nextInt(8) != 0) {
						STATIC_ROTATIONAL_GENERATOR.generate(BlockBomakellia.block.getDefaultState(), worldIn, rand, pos.add(j, l, k), 8, 255, 60, 255);
					}
				}
			}
			...
			if(net.minecraftforge.event.terraingen.TerrainGen.decorate(worldIn, rand, new net.minecraft.util.math.ChunkPos(pos), net.minecraftforge.event.terraingen.DecorateBiomeEvent.Decorate.EventType.GRASS)) {
				...
				for (int i = 0; i < Math.ceil(5D * edicarandensity); ++i) {
					...
					int l = ChunkGenSpawner.getTopSolidBlock(new BlockPos(pos.add(i, 0, k)), worldIn).getY() + 1;
					if (worldIn.getBiome(pos.add(j, l, k)) == this && rand.nextInt(8) != 0) {
						STATIC_ROTATIONAL_GENERATOR.generate(BlockArborea.block.getDefaultState(), worldIn, rand, pos.add(j, l, k), 8, 255, 60, 255);
					}
				}
			}
			...
			if(net.minecraftforge.event.terraingen.TerrainGen.decorate(worldIn, rand, new net.minecraft.util.math.ChunkPos(pos), net.minecraftforge.event.terraingen.DecorateBiomeEvent.Decorate.EventType.GRASS)) {
				...
				for (int i = 0; i < Math.ceil(5D * edicarandensity); ++i) {
					...
					int l = ChunkGenSpawner.getTopSolidBlock(new BlockPos(pos.add(i, 0, k)), worldIn).getY() + 1;
					if (worldIn.getBiome(pos.add(j, l, k)) == this && rand.nextInt(8) != 0) {
						STATIC_ROTATIONAL_GENERATOR.generate(BlockPambikalbae.block.getDefaultState(), worldIn, rand, pos.add(j, l, k), 8, 255, 60, 255);
					}
				}
			}
			...
			if(net.minecraftforge.event.terraingen.TerrainGen.decorate(worldIn, rand, new net.minecraft.util.math.ChunkPos(pos), net.minecraftforge.event.terraingen.DecorateBiomeEvent.Decorate.EventType.GRASS)) {
				...
				for (int i = 0; i < Math.ceil(5D * edicarandensity); ++i) {
					...
					int l = ChunkGenSpawner.getTopSolidBlock(new BlockPos(pos.add(i, 0, k)), worldIn).getY() + 1;
					if (worldIn.getBiome(pos.add(j, l, k)) == this && rand.nextInt(8) != 0) {
						STATIC_ROTATIONAL_GENERATOR.generate(BlockCoronacollina.block.getDefaultState(), worldIn, rand, pos.add(j, l, k), 8, 255, 60, 255);
					}
				}
			}
			...
			if(net.minecraftforge.event.terraingen.TerrainGen.decorate(worldIn, rand, new net.minecraft.util.math.ChunkPos(pos), net.minecraftforge.event.terraingen.DecorateBiomeEvent.Decorate.EventType.GRASS)) {
				for (int i = 0; i < 14; ++i) {
					...
					int l = rand.nextInt(worldIn.getHeight(pos.add(j, 0, k)).getY() + 32);
					if (worldIn.getBiome(pos.add(j, l, k)) == this) {
						STATIC_GENERATOR.generate(BlockArkarua.block.getDefaultState(), worldIn, rand, pos.add(j, l, k), 1, 100, 65, 255);
					}
				}
			}
			...
			if(net.minecraftforge.event.terraingen.TerrainGen.decorate(worldIn, rand, new net.minecraft.util.math.ChunkPos(pos), net.minecraftforge.event.terraingen.DecorateBiomeEvent.Decorate.EventType.GRASS)) {
				for (int i = 0; i < 14; ++i) {
					...
					int l = rand.nextInt(worldIn.getHeight(pos.add(j, 0, k)).getY() + 32);
					if (worldIn.getBiome(pos.add(j, l, k)) == this) {
						STATIC_SIDEWAYS_GENERATOR.generate(BlockArkarua.block.getDefaultState(), worldIn, rand, pos.add(j, l, k), 1, 100, 65, 255);
					}
				}
			}
			...
			if(net.minecraftforge.event.terraingen.TerrainGen.decorate(worldIn, rand, new net.minecraft.util.math.ChunkPos(pos), net.minecraftforge.event.terraingen.DecorateBiomeEvent.Decorate.EventType.GRASS)) {
				for (int i = 0; i < 20; ++i) {
					...
					int l = rand.nextInt(worldIn.getHeight(pos.add(j, 0, k)).getY() + 32);
					if (worldIn.getBiome(pos.add(j, l, k)) == this) {
						STATIC_GENERATOR.generate(BlockBeltanelliformis.block.getDefaultState(), worldIn, rand, pos.add(j, l, k), 1, 100, 65, 255);
					}
				}
			}
			...
			if(net.minecraftforge.event.terraingen.TerrainGen.decorate(worldIn, rand, new net.minecraft.util.math.ChunkPos(pos), net.minecraftforge.event.terraingen.DecorateBiomeEvent.Decorate.EventType.GRASS)) {
				for (int i = 0; i < 14; ++i) {
					...
					int l = rand.nextInt(worldIn.getHeight(pos.add(j, 0, k)).getY() + 32);
					if (worldIn.getBiome(pos.add(j, l, k)) == this) {
						STATIC_GENERATOR.generate(BlockConomedusites.block.getDefaultState(), worldIn, rand, pos.add(j, l, k), 1, 65, 65, 255);
					}
				}
			}
			...
			if(net.minecraftforge.event.terraingen.TerrainGen.decorate(worldIn, rand, new net.minecraft.util.math.ChunkPos(pos), net.minecraftforge.event.terraingen.DecorateBiomeEvent.Decorate.EventType.GRASS)) {
				for (int i = 0; i < 14; ++i) {
					...
					int l = rand.nextInt(worldIn.getHeight(pos.add(j, 0, k)).getY() + 32);
					if (worldIn.getBiome(pos.add(j, l, k)) == this) {
						STATIC_SIDEWAYS_GENERATOR.generate(BlockConomedusites.block.getDefaultState(), worldIn, rand, pos.add(j, l, k), 1, 65, 65, 255);
					}
				}
			}
			...
			if(net.minecraftforge.event.terraingen.TerrainGen.decorate(worldIn, rand, new net.minecraft.util.math.ChunkPos(pos), net.minecraftforge.event.terraingen.DecorateBiomeEvent.Decorate.EventType.GRASS)) {
				for (int i = 0; i < 14; ++i) {
					...
					int l = rand.nextInt(worldIn.getHeight(pos.add(j, 0, k)).getY() + 32);
					if (worldIn.getBiome(pos.add(j, l, k)) == this) {
						STATIC_GENERATOR.generate(BlockSomatohelix.block.getDefaultState(), worldIn, rand, pos.add(j, l, k), 1, 65, 65, 255);
					}
				}
			}
			...
			if(net.minecraftforge.event.terraingen.TerrainGen.decorate(worldIn, rand, new net.minecraft.util.math.ChunkPos(pos), net.minecraftforge.event.terraingen.DecorateBiomeEvent.Decorate.EventType.GRASS)) {
				for (int i = 0; i < 14; ++i) {
					...
					int l = rand.nextInt(worldIn.getHeight(pos.add(j, 0, k)).getY() + 32);
					if (worldIn.getBiome(pos.add(j, l, k)) == this) {
						STATIC_SIDEWAYS_GENERATOR.generate(BlockSomatohelix.block.getDefaultState(), worldIn, rand, pos.add(j, l, k), 1, 65, 65, 255);
					}
				}
			}
			...
			if(net.minecraftforge.event.terraingen.TerrainGen.decorate(worldIn, rand, new net.minecraft.util.math.ChunkPos(pos), net.minecraftforge.event.terraingen.DecorateBiomeEvent.Decorate.EventType.GRASS)) {
				...
				for (int i = 0; i < Math.ceil(5D * edicarandensity); ++i) {
					...
					int l = ChunkGenSpawner.getTopSolidBlock(new BlockPos(pos.add(i, 0, k)), worldIn).getY() + 1;
					if (worldIn.getBiome(pos.add(j, l, k)) == this) {
						STATIC_ROTATIONAL_GENERATOR.generate(BlockFunisia.block.getDefaultState(), worldIn, rand, pos.add(j, l, k), 2, 255, 65, 255);
					}
				}
			}
			...
			if(net.minecraftforge.event.terraingen.TerrainGen.decorate(worldIn, rand, new net.minecraft.util.math.ChunkPos(pos), net.minecraftforge.event.terraingen.DecorateBiomeEvent.Decorate.EventType.GRASS)) {
				for (int i = 0; i < 20; ++i) {
					...
					int l = rand.nextInt(worldIn.getHeight(pos.add(j, 0, k)).getY() + 32);
					if (worldIn.getBiome(pos.add(j, l, k)) == this) {
						STATIC_GENERATOR.generate(BlockNilpenia.block.getDefaultState(), worldIn, rand, pos.add(j, l, k), 2, 75, 62, 255);
					}
				}
			}
			...
			if(net.minecraftforge.event.terraingen.TerrainGen.decorate(worldIn, rand, new net.minecraft.util.math.ChunkPos(pos), net.minecraftforge.event.terraingen.DecorateBiomeEvent.Decorate.EventType.GRASS)) {
				for (int i = 0; i < 14; ++i) {
					...
					int l = rand.nextInt(worldIn.getHeight(pos.add(j, 0, k)).getY() + 32);
					if (worldIn.getBiome(pos.add(j, l, k)) == this) {
						STATIC_GENERATOR.generate(BlockAuroralumina.block.getDefaultState(), worldIn, rand, pos.add(j, l, k), 20, 200, 0, 55);
					}
				}
			}
			...
			if(net.minecraftforge.event.terraingen.TerrainGen.decorate(worldIn, rand, new net.minecraft.util.math.ChunkPos(pos), net.minecraftforge.event.terraingen.DecorateBiomeEvent.Decorate.EventType.GRASS)) {
				for (int i = 0; i < 22; ++i) {
					...
					int l = rand.nextInt(worldIn.getHeight(pos.add(j, 0, k)).getY() + 32);
					if (worldIn.getBiome(pos.add(j, l, k)) == this) {
						STATIC_GENERATOR.generate(BlockInaria.block.getDefaultState(), worldIn, rand, pos.add(j, l, k), 2, 150, 65, 255);
					}
				}
			}
