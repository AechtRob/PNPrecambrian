...
import net.lepidodendron.world.gen.WorldGenLavaFlow;
...
public class BiomeHadeanSmeltsHelper extends ElementsPNPrecambrianMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:hadean_smelts_helper")
	public static final BiomeGenCustom biome = null;
	public BiomeHadeanSmeltsHelper(ElementsPNPrecambrianMod instance) {
		super(instance, 1591);
	}
	...
	static class BiomeGenCustom extends BiomePrecambrian {
		public BiomeGenCustom() {
			super(new BiomeProperties("Hadean Smelts").setRainfall(0.95F).setBaseHeight(2.75F).setHeightVariation(0.0F).setTemperature(2.1F).setWaterColor(0x539E32));
			setRegistryName("lepidodendron:hadean_smelts_helper");
