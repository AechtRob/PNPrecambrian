...
public class BiomePaleoproterozoicBeach extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:paleoproterozoic_beach")
	public static final BiomeGenCustom biome = null;
	public BiomePaleoproterozoicBeach(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomePrecambrian {
		public BiomeGenCustom() {
			...
			super(new BiomeProperties("Palaeoproterozoic Shallows").setRainfall(0.0F).setBaseHeight(2.75F).setHeightVariation(0.001F).setTemperature(2.1F).setRainDisabled().setWaterColor(0xB00000));
