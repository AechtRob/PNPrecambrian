...
public class BiomeEdiacaranTrench extends ElementsPNPrecambrianMod.ModElement {
	...
	static class BiomeGenCustom extends BiomePrecambrian {
		public BiomeGenCustom() {
			super(new BiomeProperties("Ediacaran Deep Trench").setRainfall(0.95F).setBaseHeight(-1.999F).setHeightVariation(0.001F).setTemperature(1.1F).setWaterColor(11556675));
