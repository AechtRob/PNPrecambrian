...
public class BiomePaleoproterozoicShallows extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:paleoproterozoic_shallows")
	public static final BiomeGenCustom biome = null;
	public BiomePaleoproterozoicShallows(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomePrecambrian {
		public BiomeGenCustom() {
			...
			super(new BiomeProperties("Paleoproterozoic Shallows").setRainfall(0.0F).setBaseHeight(2.15F).setHeightVariation(0.022F).setTemperature(0.1F).setRainDisabled().setWaterColor(0xB00000));
