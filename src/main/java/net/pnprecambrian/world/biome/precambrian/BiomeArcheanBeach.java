...
public class BiomeArcheanBeach extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:archean_beach")
	public static final BiomeGenCustom biome = null;
	public BiomeArcheanBeach(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomePrecambrian {
		public BiomeGenCustom() {
			...
			super(new BiomeProperties("Archaean Tide Pools").setBaseHeight(2.75F).setHeightVariation(0.001F).setTemperature(0.6F).setWaterColor(0x539E32));
			setRegistryName("lepidodendron:archean_beach");
