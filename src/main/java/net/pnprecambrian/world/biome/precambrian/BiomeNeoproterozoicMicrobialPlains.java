...
public class BiomeNeoproterozoicMicrobialPlains extends ElementsPNPrecambrianMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:neoproterozoic_plains")
	public static final BiomeGenCustom biome = null;
	public BiomeNeoproterozoicMicrobialPlains(ElementsPNPrecambrianMod instance) {
		super(instance, 1591);
	}
	...
	static class BiomeGenCustom extends BiomePrecambrian {
		public BiomeGenCustom() {
			super(new BiomeProperties("Neoproterozoic Microbial Plains").setRainfall(0.9F).setBaseHeight(2.7F).setHeightVariation(0.0F).setTemperature(0.8F));
			setRegistryName("lepidodendron:neoproterozoic_plains");
			topBlock = BlockSandMicrobial.block.getDefaultState();
