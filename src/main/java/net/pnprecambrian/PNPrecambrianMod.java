...
@Mod(modid = net.pnprecambrian.PNPrecambrianMod.MODID, name = net.pnprecambrian.PNPrecambrianMod.NAME, version = net.pnprecambrian.PNPrecambrianMod.VERSION, dependencies = "required-after:lepidodendron@[60.0,)")
public class PNPrecambrianMod {
    ...
    @Mod.Instance(MODID)
    public static net.pnprecambrian.PNPrecambrianMod instance;
    public net.pnprecambrian.ElementsPNPrecambrianMod elements = new net.pnprecambrian.ElementsPNPrecambrianMod();
    ...
    public void preInit(FMLPreInitializationEvent event) {
        ...
        NetworkRegistry.INSTANCE.registerGuiHandler(this, new net.pnprecambrian.ElementsPNPrecambrianMod.GuiHandler());
    ...
    public void init(FMLInitializationEvent event) {
        ...
        proxy.init(event);
        MinecraftForge.EVENT_BUS.register(new net.pnprecambrian.PNWandHandler());
    }
