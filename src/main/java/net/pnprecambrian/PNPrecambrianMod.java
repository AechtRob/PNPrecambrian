...
@Mod(modid = net.pnprecambrian.PNPrecambrianMod.MODID, name = net.pnprecambrian.PNPrecambrianMod.NAME, version = net.pnprecambrian.PNPrecambrianMod.VERSION, dependencies = "required-after:lepidodendron@[63.0,)")
